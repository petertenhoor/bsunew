...
if ($headerFormat == 'left-header') $hideHeaderUntilNeeded = '0';
...
if ($hideHeaderUntilNeeded == '1' || $body_border == '1' || $headerFormat == 'left-header') $headerResize = '0';
...
<body <?php body_class(); ?> data-footer-reveal="<?php echo $footer_reveal; ?>"
                             data-header-format="<?php echo $headerFormat; ?>"
                             data-footer-reveal-shadow="<?php echo $footer_reveal_shadow; ?>"
                             data-dropdown-style="<?php echo $dropdownStyle; ?>"
                             ...
                             data-form-style="<?php echo $form_style; ?>"
                             data-form-submit="<?php echo $form_submit_style; ?>" data-is="<?php echo $icon_style; ?>"
                             ...
                             data-slide-out-widget-area-style="<?php echo $sideWidgetClass; ?>"
                             data-user-set-ocm="<?php echo $userSetSideWidgetArea; ?>"
                             ...
                             data-smooth-scrolling="<?php echo $smooth_scrolling; ?>"
            ...
            <div class="row">
                ...
                <div class="col span_9 col_last">
                    ...
                    <?php if ($has_main_menu == 'true' && $mobile_fixed == 'false' && $prependTopNavMobile != '1') { ?>
                        <div class="slide-out-widget-area-toggle mobile-icon std-menu <?php echo $sideWidgetClass; ?>"
                    ...
                    if ($sideWidgetArea == '1') { ?>
                        <div class="slide-out-widget-area-toggle mobile-icon <?php echo $sideWidgetClass; ?>"
                             data-icon-animation="simple-transform">
                    ...
                    <nav>
                            ...
                            <ul class="buttons" data-user-set-ocm="<?php echo $userSetSideWidgetArea; ?>">
                                ...
                                <?php if ($sideWidgetArea == '1') { ?>
                                    <li class="slide-out-widget-area-toggle"
                                        data-icon-animation="<?php echo $sideWidgetIconAnimation; ?>">
                        ...
                        <ul class="sf-menu">
                            ...
                            if (!empty($options['enable_social_in_header']) && $options['enable_social_in_header'] == '1' && $using_secondary != 'header_with_secondary' && $headerFormat != 'menu-left-aligned' && $headerFormat != 'left-header') {
    ...
    <?php if (!empty($options['enable-cart']) && $options['enable-cart'] == '1') { ?>
        ...
        if ($woocommerce) {
            ...
            <div class="cart-outer" data-user-set-ocm="<?php echo $userSetSideWidgetArea; ?>"
                 data-cart-style="<?php echo $nav_cart_style; ?>">
...
<?php if (!empty($options['theme-skin']) && $options['theme-skin'] == 'ascend' || $headerFormat == 'left-header') {
    get_template_part('includes/header-search');
} ?>
